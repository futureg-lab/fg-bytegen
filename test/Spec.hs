...
tests =
  TestList
    [ TestCase (assertEqual "parse string" "String \"Hello/**/\"" (readExpr "\"Hello/**/\"  ")),
      TestCase
        ( assertEqual
            "parse string with variable-width characters"
      ...
      TestCase
        ( assertEqual
            "parse while loop with control loop, and func calls"
      ...
      TestCase
        ( assertEqual
            "parse for loop with control loop, and func calls"
